    ...
    return (
        <section id="inzicht" className="py-32 md:py-48 px-6 md:px-12 bg-background relative overflow-hidden flex items-center justify-center">
            ...
            <div className="relative z-10 w-full max-w-5xl mx-auto bg-gradient-to-b from-[#0a0a0a] to-[#050505] text-primary rounded-[3rem] p-12 md:p-24 text-center shadow-[0_0_100px_rgba(255,53,0,0.05)] border border-accent/20 flex flex-col items-center">
                ...
                <h2 className="font-heading font-bold text-5xl md:text-7xl mb-8 tracking-tighter leading-[1.1]">
                    Claim je <span className="text-accent italic font-medium">garantie.</span>
                </h2>
