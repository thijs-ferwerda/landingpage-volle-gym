...
const Hero = () => {
    ...
    return (
        <section
            ref={containerRef}
            className="relative w-full min-h-[100dvh] flex flex-col justify-center items-center pb-12 pt-24 bg-background overflow-hidden"
        >
            ...
            <div className="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col items-center text-center">
                ...
                {/* Trust Indicators (Google/Gyms) */}
                <div ref={addToRefs} className="pt-8 border-t border-primary/10 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-16 max-w-4xl mx-auto w-full">
