...
const System = ({ campaign }) => {
    const isMetaAdsPage = campaign === 'uitgeputte-trainer' || campaign === 'locatie-2' || campaign === 'voorspelbaar';
    ...
    const pillars = [
        {
            ...
            desc: isMetaAdsPage
                ? <>Ons money-model verzekert dat iedere euro in marketing minimaal één euro aan nieuwe sales oplevert. Schaalbaar, overdraagbaar aan je team, en zonder dat jij de hele dag leads hoeft na te jagen.</>
                : <>Ons money-model verzekert dat iedere euro in <Link to="/sportschool-marketing" className="text-accent hover:underline underline-offset-4 decoration-accent/50 transition-all font-medium">marketing</Link> minimaal één euro aan nieuwe sales oplevert. Schaalbaar, overdraagbaar aan je team, en zonder dat jij de hele dag leads hoeft na te jagen.</>,
        ...
        },
        {
            ...
            desc: isMetaAdsPage
                ? <>Samen structureel leden werven doe je langer en beter. Leer van andere succesvolle gym eigenaren, deel je overwinningen en bouw mee aan een gezonder Nederland. Dat is onze gedeelde missie.</>
                : <>Samen <Link to="/leden-werven-sportschool" className="text-accent hover:underline underline-offset-4 decoration-accent/50 transition-all font-medium">structureel leden werven</Link> doe je langer en beter. Leer van andere succesvolle gym eigenaren, deel je overwinningen en bouw mee aan een gezonder Nederland. Dat is onze gedeelde missie.</>,
        ...
        },
        {
            ...
            desc: isMetaAdsPage
                ? <>Jij bent de accountability partner voor je klanten. Wij zijn dat voor jouw PT studio. In onze wekelijkse meetings bekijken we jouw cijfers. Blijf je achter? Dan bellen we je op om je op de rit te krijgen.</>
                : <>Jij bent de accountability partner voor je klanten. Wij zijn dat voor jouw <Link to="/pt-studio-marketing" className="text-accent hover:underline underline-offset-4 decoration-accent/50 transition-all font-medium">PT studio</Link>. In onze wekelijkse meetings bekijken we jouw cijfers. Blijf je achter? Dan bellen we je op om je op de rit te krijgen.</>,
