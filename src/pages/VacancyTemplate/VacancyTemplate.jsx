  ...
  return (
    <main className="bg-background">
      ...
      <section className="relative w-full min-h-[100vh] max-h-[1000px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/40 to-black/10 z-10" />
        <img
          src={dJob.heroImage}
      ...
      {/* Share + CTA Section */}
      {dJob.isHQ ? (
        <section className="py-24 bg-white flex flex-col items-center justify-center relative z-20 gap-12">
          {/* Deel met een vriend */}
          ...
          <Link
            to={dJob.applyUrl || `/solliciteren?role=${dJob.slug || dJob.title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`}
            className="bg-black text-white px-16 py-5 text-xl font-medium hover:bg-black/80 transition-colors"
          >
            Solliciteer nu
          </Link>
        </section>
