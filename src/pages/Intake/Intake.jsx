        ...
        <section className="min-h-screen pt-32 pb-24 px-6 bg-background flex flex-col items-center relative z-10 w-full overflow-hidden">
            ...
            <div className="max-w-4xl w-full mx-auto text-center mb-12 relative z-20 flex flex-col items-center">
                ...
                <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl text-primary tracking-tighter leading-[1.1] mb-6">
                    Meld je aan voor  <br className="hidden md:block" />
                    een <span className="font-drama italic text-primary/70">Volle Gym.</span>
                </h1>

                <p className="font-sans text-primary/70 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-8">
                    Vul het korte formulier hieronder in om te kijken of jouw club in aanmerking komt.
                </p>
            </div>
            ...
            <div className="w-full max-w-4xl mx-auto bg-white rounded-3xl shadow-xl border border-primary/10 overflow-hidden relative z-20 flex justify-center items-center">
                ...
                <iframe
                    src={`https://api.leadconnectorhq.com/widget/survey/yi2HMgCtZdzbGPakU69e?cb=${timestamp}&notrack=true`}
